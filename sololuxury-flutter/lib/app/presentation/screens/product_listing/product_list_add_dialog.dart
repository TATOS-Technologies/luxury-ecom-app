                  ...
                  child: Column(
                    ...
                    children: [
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: DropdownButton<SizeModel>(
                                        ...
                                        hint: productController.sizeList.toString() == "[]"
                                            ...
                                            : Text("${productController.sizeList.first.label}",
                                  ...
                                  Row(
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: Text(
                                          LanguageConstants.sizeChartText.tr,
                                          style: AppStyle.textStyleUtils600(color: brown743617).copyWith(
                                      ...
                                      productController.dropdownValidator.value
                                          ? Text(
                                              ...
                                              style: AppStyle.textStyleUtils400(color: Colors.red),
                                            )
                                          : const SizedBox(),
                                    ],
                                  ),
                              ...
                              ? InkWell(
                                  child: Container(
                                    ...
                                    child: Text(
                                      ...
                                      style: AppStyle.textStyleUtils500_12(color: Colors.white),
                                    ),
                                  ),
                                  onTap: () async {
                              ...
                              : Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        Get.toNamed<dynamic>(RoutesConstants.checkoutOrderScreen,
                      ...
                      Text(
                        ...
                        style: AppStyle.textStyleUtils500(color: Colors.white, size: 19),
                      ),
                      const SizedBox(height: 5),
                      SizedBox(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                ...
                                                style: AppStyle.textStyleUtils400(size: 11.0),
                                              ),
                                              Text(
