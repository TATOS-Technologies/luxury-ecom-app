          ...
          children: [
            Stack(
              ...
              children: [
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "${item.name} ${LanguageConstants.addedToYourCart.tr}".toTitleCase(),
                        ...
                        children: [
                          Container(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: "${AppConstants.productImageUrl}${item.getProductImage()}",
                              errorWidget: (
                ...
                productController.dialogLoader.value ? const ScreenLoading() : Container(),
              ],
            ),
          ],
        ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      '$text',
                      style: AppTextStyle.textStyleUtils500_16(color: appColorPrimary),
                    ),
                    IconButton(
                      onPressed: () {
