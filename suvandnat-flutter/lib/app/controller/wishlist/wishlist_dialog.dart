...
class WishlistDialog {
  static void showAddDialog(BuildContext context, String? dataname, String? customimage) {
    showDialog(
      context: context,
                            ...
                            children: [
                                ...
                                children: [
                                  InkWell(
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(20), color: appColorPrimary),
                                      child: Text(
                                        LanguageConstants.viewCartText.tr.toUpperCase(),
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  padding: const EdgeInsets.symmetric(horizontal: 14.0, vertical: 10.0),
                                  decoration:
                                      BoxDecoration(borderRadius: BorderRadius.circular(20), color: appColorPrimary),
                                  child: Text(
                                    LanguageConstants.continueShoppingText.tr.toUpperCase(),
                                    textAlign: TextAlign.center,
                                    style: const TextStyle(
                                        fontSize: 15.0, color: Colors.white, fontWeight: FontWeight.w500),
                                  ),
